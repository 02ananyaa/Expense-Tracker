...
//        }
        for (Expense expense : expenseList){
            // Check if the category is not null before accessing its properties
            if (expense.getCategory() != null) {
                expense.setCategoryName(expense.getCategory().getName());
            } else {
                expense.setCategoryName("No Category");  // Or some default value
            }

            // Ensure that the dateTime is parsed correctly
